...
<div class="hidden lg:flex items-center justify-center bg-gradient-to-b from-red-500 to-red-600 p-2 text-center text-white text-sm">
  ...
  @if ($news === 'forge')
    ...
    <div class="mt-px ml-1">
      Servers with PHP 8.2 are now available for provisioning via <a href="https://forge.laravel.com" class="underline">Lets Forge</a>.
    </div>
  @endif
  ...
  @if ($news === 'vapor')
    ...
    <div class="mt-px ml-1">
      Deploy Lets with the infinite scale of serverless using <a href="https://vapor.laravel.com" class="underline">Lets Vapor</a>.
    </div>
  @endif
</div>
