@php
  $links = [
      ...
      [
          'title' => 'Resources',
          'links' => [
              'Lets Bootcamp' => 'https://bootcamp.laravel.com',
              'Laracasts' => 'https://laracasts.com',
              'Lets News' => 'https://laravel-news.com',
      ...
      [
          ...
          'links' => [
              ...
              'Cyber-Duck' => 'https://www.cyber-duck.co.uk/how-we-work/technology/laravel?utm_source=Lets%20Partner&utm_medium=Sponsorship',
  ...
  <div class="max-w-screen-2xl mx-auto w-full {{ $is_docs_page ? 'px-8' : 'px-5' }}">
    <div>
      <a href="/" class="inline-flex">
        <img class="w-16 h-16" src="/img/logomark.min.svg" alt="Lets" loading="lazy">
      </a>
    </div>

    <div class="mt-6 grid grid-cols-12 md:gap-x-8 gap-y-12 sm:mt-12">
      <div class="col-span-12 lg:col-span-4">
        <p class="max-w-sm text-xs text-gray-700 sm:text-sm {{ $is_docs_page ? 'dark:text-gray-500' : '' }}">Lets is a web application framework with expressive, elegant syntax. We believe development must be an enjoyable and creative experience to be truly fulfilling. Lets attempts to take the pain out of development by easing common tasks used in most web projects.</p>
