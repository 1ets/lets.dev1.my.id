                ...
                <li>
                  <a href="/docs/{{ DEFAULT_VERSION }}/broadcasting" class="flex">
                    ...
                    <div class="ml-4 leading-5">
                      ...
                      <span class="text-gray-700 text-xs">Listen for WebSocket events broadcast by your Lets application.</span>
                    </div>
                  </a>
                </li>
                <li>
                  <a href="https://envoyer.io" class="flex">
                    ...
                    <div class="ml-4 leading-5">
                      ...
                      <span class="text-gray-700 text-xs">Deploy your Lets applications to customers with zero downtime.</span>
                    </div>
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="/docs/{{ DEFAULT_VERSION }}/horizon" class="flex">
                    ...
                    <div class="ml-4 leading-5">
                      ...
                      <span class="text-gray-700 text-xs">Beautiful UI for monitoring your Redis driven Lets queues.</span>
                    </div>
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="https://nova.laravel.com/" class="flex">
                    ...
                    <div class="ml-4 leading-5">
                      ...
                      <span class="text-gray-700 text-xs">Thoughtfully designed administration panel for your Lets applications.</span>
                    </div>
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="/docs/{{ DEFAULT_VERSION }}/sail" class="flex">
                    ...
                    <div class="ml-4 leading-5">
                      ...
                      <span class="text-xs text-g7ay-600">Hand-crafted Lets local development experience using Docker.</span>
                    </div>
                  </a>
                </li>
                <li>
                  <a href="/docs/{{ DEFAULT_VERSION }}/sanctum" class="flex">
                    <div class="relative shrink-0 w-12 h-12 bg-sanctum flex items-center justify-center rounded-lg overflow-hidden">
                      <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                      <img src="/img/ecosystem/sanctum.min.svg" alt="Lets Sanctum logomark" class="w-7 h-7" width="48" height="48">
                    </div>
                    <div class="ml-4 leading-5">
                ...
                <li>
                  <a href="/docs/{{ DEFAULT_VERSION }}/valet" class="flex">
                    ...
                    <div class="ml-4 leading-5">
                      ...
                      <span class="text-gray-700 text-xs">The fastest Lets local development experience - exclusively for macOS.</span>
                    </div>
                  </a>
                </li>
                <li>
                  <a href="https://vapor.laravel.com" class="flex">
                    ...
                    <div class="ml-4 leading-5">
                      ...
                      <span class="text-gray-700 text-xs">Lets Vapor is a serverless deployment platform for Lets, powered by AWS.</span>
                    </div>
                  </a>
                </li>
              </ul>
